...
session_start();
	...
	if(!isset($_SESSION["loggedin"]) && !isset($_SESSION["username"]) === true){
    ...
    // printf($pSql);
    $profile = mysqli_query($conn, $pSql);
...
<html lang="en">
    ...
    <body>
        ...
        <!-- ========== MAIN CONTENT ========== -->
        <main id="content" role="main" style="margin-top: 100px;">
            <!-- <div class="content-space-t-3 content-space-t-lg-5 content-space-b-2 content-space-b-lg-3 hero-image ">
                
            </div> -->
            <center><img src="<?php echo $profile_pic ?>" style="width:250px;"></center> 
            <div class="text-center "> <h1 class="my-5">Hello, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to MSARII </h1></div>
            <!-- Profile -->
            <center>   
            <h2 class="my-5">Your Email Id : <b><?php echo htmlspecialchars($email); ?></b>.  </h2>

		    <p>
		        <a href="upload-portfolio.php" class="btn btn-warning">Upload Portfolio</a>
